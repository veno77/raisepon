...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($session->getError())
        ...
        print "<center>Set Succesfully</center>";
	}
...
print "<center><h2>OLT:" . $olt_name . "</h2><h1>ONU:" . $slot_id . "/" . $port_id . "/" . $pon_onu_id . " Statistics</center></h1>";
...
print "&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' name='SUBMIT' value='Reboot'>";
print "</form>";
