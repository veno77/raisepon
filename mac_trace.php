...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
		...
		if ($status) {
			...
			if ($row{'TYPE'} == "1") {
				$oid = "1.3.6.1.4.1.8886.18.2.23.1.1.8" . $mac_address ;
				$oid_2 = "1.3.6.1.4.1.8886.18.2.23.1.1.2" . $mac_address;
				$oid_3 = "1.3.6.1.4.1.8886.18.2.23.1.1.3" . $mac_address;
				$oid_4 = "1.3.6.1.4.1.8886.18.2.23.1.1.4" . $mac_address;
				$oid_5 = "1.3.6.1.4.1.8886.18.2.23.1.1.5" . $mac_address;
